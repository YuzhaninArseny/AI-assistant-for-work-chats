...
from command_service_app.core.service_client import response_draft_generator_client

router = APIRouter(prefix="/draft", tags=["draft"])


@router.get('/')
async def draft(db_client: DbClientDep, chat_id: int):
    try:
        ...
        draft = await response_draft_generator_client.post('/draft', json={'messages': messages})
        return JSONResponse(
